...
namespace @string
{
    internal class Program
    {
        ...
        string";
            ...
            //string text21 = "This is a "string" in C#."; // Error
            //string texttest22 = @"This is a "string" in C#."; // error
            string texttest23 = @"This is a ""string"" in C#."; // valid
